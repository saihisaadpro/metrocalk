...
export function fakeClient(over: Partial<EditorClient> = {}): EditorClient {
  return {
    ...
    addCameraHere: vi.fn(() => Promise.resolve("cam-created")),
    sceneCameras: vi.fn(() => Promise.resolve([])),
    setActiveCamera: vi.fn(() => Promise.resolve(true)),
    recaptureCamera: vi.fn(() => Promise.resolve(true)),
    setCameraFov: vi.fn(() => Promise.resolve(true)),
    lookThroughCamera: vi.fn(() => Promise.resolve(true)),
