...
| [017](017-generation-tier-and-ai-patch-contract.md) | Generation tier (placeholder-first stream-in · `MeshGenerator` trait + fake/real seam · metered last resort) + the AI-patch contract (schema-validated transactional patches, no raw LLM mutation) | Accepted — M6 |
