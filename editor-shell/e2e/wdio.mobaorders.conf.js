// WebdriverIO config for the GP-08 STANDING ORDERS run (see wdio.moba.conf.js for the pipeline run): drive a real match in the packaged .exe and capture the
...
export const config = {
  ...
  specs: ["./specs/moba-orders.e2e.js"],
