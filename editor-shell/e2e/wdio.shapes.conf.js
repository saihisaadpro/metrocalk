// Shape Studio visual acceptance — the Build sub-engine's creation flows exercised on the PACKAGED .exe
// with OS-composited pixel captures. Empty scene (MTK_SCENE_N=0) so only what the test creates appears.
//
// Run: node "node_modules\@wdio\cli\bin\wdio.js" run wdio.shapes.conf.js
