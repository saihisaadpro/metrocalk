// Shot preview acceptance — the cutscene camera posed at the playhead on the PACKAGED .exe, with
// OS-composited pixel captures. Empty scene (MTK_SCENE_N=0) so only what the test creates appears.
//
// Run: node "node_modules\@wdio\cli\bin\wdio.js" run wdio.cinemapreview.conf.js
...
export const config = {
  ...
  specs: ["./specs-cinemapreview/cinema-preview.e2e.js"],
  maxInstances: 1,
