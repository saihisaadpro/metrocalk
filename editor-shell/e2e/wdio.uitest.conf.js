// LIVE UI-overlay check — verify floating UI (the File menu) opens ABOVE the app chrome and is not clipped,
// against the packaged .exe. Empty scene (MTK_SCENE_N=0).
//
// Run: node "node_modules\@wdio\cli\bin\wdio.js" run wdio.uitest.conf.js
