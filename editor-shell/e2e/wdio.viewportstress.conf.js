// WebdriverIO config for the VIEWPORT STRESS AUDIT run (see wdio.moba.conf.js for the pipeline run): drive a real match in the packaged .exe and capture the
...
export const config = {
  ...
  specs: ["./specs/viewport-stress.e2e.js"],
