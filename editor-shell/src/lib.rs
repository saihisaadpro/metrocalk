...
pub use cinema_intent::{
    add_shot_ops, bitrate_for, clear_shot_camera_ops, cutscene_of, describe_shot, framing_catalog,
    move_shot_ops, plan_render, preview_time, remove_shot_ops, render_frame_name,
    render_frame_size, render_movie_name, reply_for as cinema_reply,
    ...
    PathSample, RenderFormat, RenderPlan, RenderReply, RenderScope, ShotRow, ShotSpec,
    StandAtReply, SubjectCandidate, SubjectCatalog, CINEMA_COMPONENT, DEFAULT_RENDER_FPS,
    DEFAULT_RENDER_HEIGHT, MAX_MOVIE_DIMENSION, MAX_RENDER_DIMENSION, MAX_RENDER_FRAMES,
    MAX_RENDER_NAME, RENDER_HEIGHTS, RENDER_RATES,
};
